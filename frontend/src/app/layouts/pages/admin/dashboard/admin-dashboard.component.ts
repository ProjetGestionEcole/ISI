...
export class AdminDashboard implements OnInit, OnDestroy {
  ...
  totalUsers = computed(() => {
    ...
    return stats ? stats.totalEleves + stats.totalEnseignants : 0;
  });
  ...
  completionRate = computed(() => {
    ...
    return stats.totalEleves > 0 ? Math.round((inscritCount / stats.totalEleves) * 100) : 0;
  });
  ...
  getMetricValue(value: any): number {
